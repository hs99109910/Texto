...
import com.texto.sms.databinding.ActivityArchivedConversationsBinding
import com.texto.sms.extensions.config
import com.texto.sms.extensions.conversationsDB
import com.texto.sms.extensions.removeAllArchivedConversations
...
class ArchivedConversationsActivity : SimpleActivity() {
    ...
    private fun removeAll() {
        textoConfirmDialog(
            message = getString(R.string.empty_archive_confirmation),
            isDestructive = true
        ) {
