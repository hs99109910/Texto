...
import com.texto.sms.databinding.ItemAttachmentMediaPreviewBinding
...
import com.texto.sms.extensions.onGlobalLayout
        ...
        Glide.with(binding.thumbnail)
            ...
            .listener(object : RequestListener<Drawable> {
                override fun onLoadFailed(e: GlideException?, model: Any?, target: Target<Drawable>, isFirstResource: Boolean): Boolean {
                    ...
                    binding.thumbnail.setImageResource(R.drawable.ic_image_vector)
                    binding.thumbnail.applyColorFilter(primaryColor)
