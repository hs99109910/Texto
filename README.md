...
Texto is optimized for speed with a small app size and efficient SMS backup support.
...
- Nothing is uploaded anywhere — SMS never touches the network, and the only use of the
  internet permission is sending and receiving MMS through your carrier  
- Permissions are limited to what the features need: contacts (names and photos on threads),
  camera and microphone (MMS attachments you record yourself), call log (ranks people you
  called recently higher when picking a recipient)  
